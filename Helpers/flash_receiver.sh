...
#   ./flash_receiver.sh --port "/dev/ttyUSB1" -f
#
# Mirrors flash_espnow_rx.sh: compile-only by default; add -f to flash.
...
SKETCH_DIR="${PROJECT_ROOT}/Firmware/Receiver"
...
echo "=============================================="
echo "Integrated Wireless DMX Receiver"
...
# Compile the integrated receiver sketch
if ! "${COMPILE_CMD[@]}"; then
    echo ""
    echo "=============================================="
    echo "COMPILE FAILED"
