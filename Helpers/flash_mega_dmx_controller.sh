#!/usr/bin/env bash
# Build/flash the simple USB-controlled Arduino Mega DMX controller.
#
# Usage:
#   ./Helpers/flash_mega_dmx_controller.sh                 # compile only
#   ./Helpers/flash_mega_dmx_controller.sh -f              # compile + flash
...
SKETCH_DIR="${PROJECT_ROOT}/Tests/mega_dmx_controller"
PORT="/dev/ttyUSB1"
FLASH=false
