...
* Binary CRC-protected transmitter management protocol.
* Multipart receiver telemetry reports and bounded receiver cache.
* Telemetry freshness, timeout recovery, and scheduler status reporting.
...
* Additional transmitter disconnect/reconnect fault-injection testing.
* Production packaging, service installation, and GUI frontend.
